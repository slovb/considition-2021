...
def main() -> None:
    ...
    '''
    config = Config(RANDOMIZE=False, LOG_RESIZE=False, LOG_PLACED=False, ENABLE_LIMIT_NUM_CANDIDATES=False, PREFERRED_NUM_CANDIDATES=150, ENABLE_OPTIMAL_DISTANCE=False, MUL_OPTIMAL_X=1.0, MUL_OPTIMAL_Y=1.0, MUL_OPTIMAL_Z=1.0, ENABLE_HEAVY_PRIORITY=True, PENALTY_NOT_HEAVY=42.15992028364802, ENABLE_WEIGHT=True, PENALTY_HEAVY_ON_LIGHT=45.927, PENALTY_HEAVY_ON_MEDIUM=11.1537, PENALTY_HEAVY_ON_HEAVY=0, MUL_WEIGHT=91247.98325374069, ENABLE_SIDE_ALIGN=True, MUL_SIDE_ALIGN=1.1261022213600007, ENABLE_X=True, MUL_X=6.985596880664332, EXP_X=1.9800000000000002, ENABLE_BOUNDING=True, PENALTY_BOUNDING_BREAK=88329.8219153818, MUL_BOUNDING=1.9355876185387513, EXP_BOUNDING=1.0, ENABLE_ORDER_SKIP=True, ORDER_BASE_REDUCTION=65.53600000000002, ORDER_BASE=20.287098, EXP_ORDER_N=2, MUL_ORDER_SKIP=4.861096431114389, EXP_ORDER_SKIP=2.4200000000000004, ENABLE_ORDER_BREAK=True, MUL_ORDER_BREAK=4886.068863958346, ENABLE_BOUNDED_X=True, MUL_BOUNDED_X=178120.88369971208)
